...
const QueueAppointment = require('../routes/models/QueueAppointment');
const {
  normalizeQueueAppointmentInput,
  toQueueAppointmentResponse,
  assertMongoReady
} = require('./queueAppointmentShape');
...
function buildListFilter({ userId, status, targetUserId }) {
...
module.exports = {
  ...
  listQueueAppointmentsByUser,
  getQueueAppointmentById,
  updateQueueAppointment,
  deleteQueueAppointment,
  mapMongoError
};
