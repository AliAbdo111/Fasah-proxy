// @ts-nocheck
/* Ported from services/bookingDailyLimits.js */
...
export { TRANSIT_KIND_STANDARD };
export { TRANSIT_KIND_EXIT };
export { normalizeTransitBookingKind };
export { FEATURE_TRANSIT_BOOKING };
export { FEATURE_IMPORT_BOOKING };
export { DEFAULT_USER_FEATURES };
export { PLAN_LIMITED };
export { PLAN_MONTHLY_ONLY };
export { PLAN_OPEN };
export { CONSUMPTION_DAILY };
export { CONSUMPTION_MONTHLY };
export { CONSUMPTION_PAID_EXTRA };
export { CONSUMPTION_OPEN };
export { bookingDayTimezone };
export { bookingDayYmd };
export { bookingDayYm };
export { utcYmd };
export { utcYm };
export { defaultMaxTransit };
export { defaultMaxImport };
export { defaultMaxDailyBookings };
export { defaultMaxMonthlyBookings };
export { syncUserBookingDay };
export { loadUserBookingState };
export { userHasFeature };
export { totalDailyBookings };
export { totalMonthlyBookings };
export { resolveFeaturesForApi };
export { bookingStatsPayload };
export { resolveConsumptionDecision };
export { assertCanBook };
export { assertCanTransitBook };
export { assertCanImportBook };
export { recordBookingSuccess };
export { recordTransitBookingSuccess };
export { recordImportBookingSuccess };
export { resetAllUsersDailyBookingCounters };

const bookingDailyLimits = {
...
export default bookingDailyLimits;
